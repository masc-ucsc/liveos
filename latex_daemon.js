...
var latex_server     = require("./server/lib/latex_server.js");

//check config files
var conf = JSON.parse(fs.readFileSync("etc/server.json"));
var port = conf.ports.latex;
...
var latexs = new latex_server(__dirname, io, tserver);
...
//Start listening
io.listen(port);
console.log("LaTeX daemon started successfully on port " + port);
