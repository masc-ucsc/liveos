...
},{"./lib/createNodeUI":2,"./lib/custom_merge":3,"./lib/renderLink":4,"./lib/renderNode":5,"ngraph.graph":6,"ngraph.pixi":8}],2:[function(require,module,exports){
...
module.exports = function (graph, settings, synthesisClient_callback) {
  self = this;
  ...
  graphInput(pixiGraphics, layout, synthesisClient_callback);
...
},{"./lib/custom_merge":10,"./lib/graphInput":11,"ngraph.forcelayout":12,"ngraph.physics.simulator":15}],9:[function(require,module,exports){
/**
...
},{"./addWheelListener":9}],12:[function(require,module,exports){
...
},{"ngraph.physics.primitives":13,"ngraph.physics.simulator":15,"ngraph.random":14}],13:[function(require,module,exports){
module.exports = {
  Body: Body,
  Vector2d: Vector2d
  // that's it for now
...
},{"./lib/dragForce":16,"./lib/eulerIntegrator":17,"./lib/exposeProperties":18,"./lib/spring":19,"./lib/springForce":20,"ngraph.merge":21,"ngraph.quadtreebh":22}],16:[function(require,module,exports){
/**
