...
ot.CodeMirrorAdapter = (function (global) {
  ...
  CodeMirrorAdapter.prototype.setOtherCursor = function (cursor, color, clientId, clientName) {
    ...
    if (cursor.selection.length === 0) {
      ...
      //cursorEl.innerHTML = '&nbsp;';
      cursorEl.innerHTML = '<div><div></div>&nbsp;<div class="codemirror_cursor_custom" style="background-color:'+color+'">'+clientName+'</div></div>';
