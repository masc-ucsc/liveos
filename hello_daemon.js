...
var fs               = require('fs');
var hello_server     = require('./server/lib/hello_server.js');
...
var hellos = new hello_server(__dirname, io);

//master daemon events
os.on('connect', function() {
  os.emit('update_tokens_req', {name: 'hello'});
});
...
//Start listening
io.listen(conf.ports.hello);
console.log('hello daemon started successfully on port ' + conf.ports.hello);
